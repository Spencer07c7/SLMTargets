...
SLMTargets enables the production of custom 3-D holograms by interfacing with reflective _phase only_ LCoS SLMs. As such, it is important to have a satisfory understanding of the physics governing hologram generation. The basic operating principle of a phase only SLM is simple: the phase of laser light reflected off a SLM liquid crystal pixel array is dependent upon the refractive index of the liquid crystal pixel that it passes through. Since the refractive index of each pixel is determined by the voltage applied to it, the phase of the reflected laser wavefront can be altered in a pixelwise, spatially specific manner. 
